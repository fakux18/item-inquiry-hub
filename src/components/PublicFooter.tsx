      ...
      <div className="container-custom py-12">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  <p className="text-light-gray">Lun - Vie: 9:00 AM - 6:00 PM</p>
                  <p className="text-light-gray">Sáb: 9:00 AM - 4:00 PM</p>
        ...
        <div className="border-t border-mid-gray-blue/30 mt-12 pt-8 text-center">
          <p className="text-light-gray">
            ...
            <span className="hover:text-golden-yellow transition-colors duration-200 cursor-pointer"> Política de Privacidad</span> | 
            <span className="hover:text-golden-yellow transition-colors duration-200 cursor-pointer"> Términos de Servicio</span>
          </p>
        </div>
      </div>
    </footer>
